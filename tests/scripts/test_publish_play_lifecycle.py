...
spec = importlib.util.spec_from_file_location(
    'publish_play_lifecycle', Path(__file__).parents[2] / 'scripts/publish_play_lifecycle.py')
...
def test_thirteen_versioned_puts_are_conditional_and_never_deploy(packages):
