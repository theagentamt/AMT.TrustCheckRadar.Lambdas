...
### Unwired V1 authority core

Changes limited to `src/shared_check_authority/`, its isolated tests, authority
handoff and enumerated CI/release support paths classify as `authority_manual`.
