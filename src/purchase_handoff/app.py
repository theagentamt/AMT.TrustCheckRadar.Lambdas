...
from service import process_purchase_handoff
...
def lambda_handler(event, _context):
    ...
    try:
        ...
        response = process_purchase_handoff(account_id=account_id, payload=payload)
...
def extract_account_id(event: dict) -> str:
    ...
    raise AppError("UNAUTHORIZED", "A trusted caller identity is required for purchase handoff.", retryable=False)
