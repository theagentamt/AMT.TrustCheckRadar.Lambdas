...
Selection approval is separate from the original basic-content approval.
"""
import hashlib
import json
...
VERSION = 'recovery-selection-1.0.0'
...
def ordered_actions(answers):
    """Deterministic mechanics; select() checks content/session availability."""
